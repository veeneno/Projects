...
module.exports = async function (username, password, numDeSB, head) {

  console.log("sben sendo executado")
  ...
  async function clicarNoFollowing() {
    ...
    try {
      ...
      for (let i = 0; i < numDeSB; i++) {
          ...
          const isFollowing = cellInnerDivContent.includes('Following');
          const isFollow = cellInnerDivContent.includes('Follow');
          ...
          if (isFollowing) {
              ...
              await clicarNoBlock()
              await clicarNoBotaoPeloNome(100, "Block")
              await clicarNoBotaoPeloNome(100, "Blocked")
              await clicarNoBotaoPeloNome(100, "Unblock")
